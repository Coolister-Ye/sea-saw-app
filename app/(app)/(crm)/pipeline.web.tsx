...
function buildCopyBase(pipeline: any) {
...
export default function PipelineScreen() {
  ...
  const handleUpdateSuccess = (res?: any) => {
    ...
    // Always update the view row to ensure PipelineDisplay shows latest data
    setViewRow(updated);
