...
import ProductionRelatedOrderSelector from "@/components/sea-saw-page/production/production-order/input/selectors/ProductionRelatedOrderSelector";
    ...
    () => ({
      related_order: {
        ...
        render: (_col: any, meta: any) => (
          <ProductionRelatedOrderSelector def={meta} />
        ),
        skipFilter: true,
      },
