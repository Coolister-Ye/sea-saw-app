...
function Button({
  ...
  const _className = clsx(
    ...
    variant === "secondary.light" &&
      "bg-secondary-light dark:bg-dark-secondary-light",
    variant === "secondary.dark" &&
      "bg-secondary-dark dark:bg-dark-secondary-dark",
    variant === "success" && "bg-success dark:bg-dark-success",
    variant === "success.light" &&
      "bg-success-light dark:bg-dark-success-light",
    ...
    variant === "outlined" &&
      "bg-transparent ring-1 ring-inset ring-gray-300 hover:bg-gray-100",
  ...
  const _classNameText = clsx(
    ...
    variant.startsWith("success") &&
      "text-success-contrastText dark:text-dark-success-contrastText",
    variant.startsWith("error") &&
      "text-error-contrastText dark:text-dark-error-contrastText",
    className
      ?.split(" ")
  ...
  return (
    <Pressable className={_className} disabled={loading} {...rest}>
      {loading ? (
